                            ...
                            >
                                ...
                                @foreach ($maestros as $maestro)
                                    <option
                                        ...
                                        @selected(old('idMaestro') == $maestro->idUsuario)
                                    >
                                        {{ $maestro->nombre }}
                            ...
                            >
                                ...
                                @foreach ($escuelas as $escuela)
                                    <option
                                        ...
                                        @selected(old('escuela_idEscuela') == $escuela->idEscuela)
                                    >
                                        {{ $escuela->nombre }}
                                    </option>
                                @endforeach
