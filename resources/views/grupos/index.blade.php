                    ...
                    <table class="min-w-full border-collapse">
                        <thead>
                            <tr class="bg-gray-100">
                                ...
                                <th class="border px-3 py-2 text-left">Maestro responsable</th>
                                <th class="border px-3 py-2 text-left">Escuela</th>
                        ...
                        <tbody>
                            @forelse ($grupos as $grupo)
                                <tr>
                                    ...
                                    <td class="border px-3 py-2">
                                        {{ $grupo->maestro?->nombre }}
                                        {{ $grupo->maestro?->apellidoPaterno }}
                                        {{ $grupo->maestro?->apellidoMaterno }}
                                    </td>

                                    <td class="border px-3 py-2">
                                        {{ $grupo->escuela?->nombre ?? 'Sin escuela' }}
                                    </td>
                                    ...
                                    <td class="border px-3 py-2">
                                        <div class="flex gap-2">
                                            <a
                                                href="{{ route('grupos.edit', ['grupo' => $grupo->idGrupo]) }}"
                                            ...
                                            <form
                                                method="POST"
                                                action="{{ route('grupos.destroy', ['grupo' => $grupo->idGrupo]) }}"
