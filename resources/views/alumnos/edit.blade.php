    ...
    <div class="py-12">
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                <form
                    method="POST"
                    action="{{ route('alumnos.update', ['alumno' => $alumno->idAlumno]) }}"
                >
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                value="{{ old('apellidoPaterno', $alumno->apellidoPaterno) }}"
                                maxlength="35"
                                required
                                class="mt-1 block w-full rounded border-gray-300"
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="fNac"
                                name="fNac"
                                value="{{ old('fNac', $alumno->fNac?->format('Y-m-d')) }}"
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach ($grupos as $grupo)
                                    <option
                                        value="{{ $grupo->idGrupo }}"
                                        @selected(old('grupo_idGrupo', $alumno->grupo_idGrupo) == $grupo->idGrupo)
                                    >
                        ...
                        <div>
                            ...
                            >
                                <option
                                    value="1"
                                    @selected(old('estado', $alumno->estado ? '1' : '0') == '1')
                                >
                                    Activo
                                </option>
                                ...
                                <option
                                    value="0"
                                    @selected(old('estado', $alumno->estado ? '1' : '0') == '0')
                                >
                                    Inactivo
                                </option>
                            </select>
