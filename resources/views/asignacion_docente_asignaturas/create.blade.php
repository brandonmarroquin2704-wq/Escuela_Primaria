    ...
    <div class="py-12">
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white p-6 shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('asignaciones-docentes.store') }}">
                    @csrf
                            ...
                            >
                                ...
                                @foreach ($asignaturas as $asignatura)
                                    <option
                                        ...
                                        @selected(old('asignatura_idAsignatura') == $asignatura->idAsignatura)
                                    >
                                        {{ $asignatura->nombre }}
                                    </option>
                                @endforeach
                            ...
                            >
                                ...
                                @foreach ($docentes as $docente)
                                    <option
                                        ...
                                        @selected(old('docente_idUsuario') == $docente->idUsuario)
                                    >
                                        {{ $docente->nombre }}
